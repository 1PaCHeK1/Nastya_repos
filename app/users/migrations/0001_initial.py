# Generated by Django 4.1.2 on 2022-10-17 15:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_newsletter', models.PositiveSmallIntegerField(choices=[(0, 'Получать рассылку'), (1, 'Не получать рассылку')], default=0)),
            ...
            managers=[
                ('manager_objects', users.managers.OnlyManager()),
